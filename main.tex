...
\DeclareFieldFormat{url}{Disponível em: \url{#1}} % exibição da URL nas referências
...
% Indentação dos parágrafos (não editar)
...
\begin{document}
    ...
    \include{2-textuais/05-teste-glossario}
    ...
    \begin{anexosenv}
        ...
        \input{3-pos-textuais/anexos/02-anexo-b}
    \end{anexosenv}
